  ...
  switch (name) {
    ...
    case 'add':
      return (
        <path
          {...props}
          d="M931.2 441.2H558.8V68.8c0-32.1-26.7-58.8-58.8-58.8c-32.1 0-58.8 26.7-58.8 58.8v372.4H68.8C36.7 441.2 10 467.9 10 500c0 32.1 26.7 58.8 58.8 58.8h372.4v372.4c0 32.1 26.7 58.8 58.8 58.8c32.1 0 58.8-26.7 58.8-58.8V558.8h372.4c32.1 0 58.8-26.7 58.8-58.8C990 466.1 965.1 441.2 931.2 441.2z"
        />
      );
    default:
      return <path />;
